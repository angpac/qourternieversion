-- Expose whether the game has ended, so the web guest client can stop
-- polling and show a "session ended" state instead of the last stale
-- queue/court/score snapshot it happened to have before the game closed.
...
begin
  ...
  return jsonb_build_object(
    ...
    'game_has_ended', v_game.status = 'ended',
